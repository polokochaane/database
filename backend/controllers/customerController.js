...
exports.addCustomer = async (req, res) => {
    try {
        ...
        // Insert customer (customer_id auto-generated by SERIAL)
        const result = await db.query(`
            ...
            RETURNING customer_id, account_number, first_name, last_name, email
        `, [account_number, first_name, last_name, email, phone || '', address || '', district || '']);

        // Return the created customer with auto-generated ID
        res.status(201).json({ 
            success: true, 
        ...
        if (error.code === '23505') { // PostgreSQL unique violation
            return res.status(409).json({ error: 'Account number or email already exists' });
        }
